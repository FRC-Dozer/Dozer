    ...
    return new YieldAdapterIterable<T>() {
      public YieldAdapterIterator<T> iterator() {
            ...
            try {
              try {
                ...
                client.collect(new ResultHandler<T>() {
                  public void handleResult(final T value) throws CollectionAbortedException {
                    try {
        ...
        return new YieldAdapterIterator<T>() {
          ...
          @Override
          /**
           * Iterator's finalize() can be used to tell when it is out of scope, and the collecting
          ...
          /**
           * This can be manually called by the calling code to force release of resources at the
